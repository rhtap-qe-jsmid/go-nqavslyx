...
export IMAGE_URL=${IMAGE_URL-nexus-docker-nexus.apps.rosa.rhtap-services.xmdt.p3.openshiftapps.com/rhtap/go-nqavslyx:$CI_TYPE-$TAG}
...
export GITOPS_REPO_URL=https://github.com/rhtap-qe-jsmid/go-nqavslyx-gitops
